...
public class Cliente extends Thread{
    ...
    public boolean mostrarContenidoDeserializadoXML(String nombreServer, String info){
        String rutaArchivo = "./sources/info/" + nombreServer + ".xml"; // Cambia esto por la ruta que desee
    ...
    public void mostrarContenidoDeserializadoJSON(String nombreSer, String info){
        try {
            ...
            String rutaArchivo = "./sources/info/" + nombreSer + ".js"; // Cambia esto por la ruta que desees
    ...
    public boolean validarArchivo(String nombreServer) {
        ...
        String xmlFilePath = "./sources/info/" + nombreServer +".xml";
    ...
    public static String mostrarContenido(){
        return "Los url implementadas han sido las siguientes :" +
                "HTTP " +
                "<a href=http://localhost:3754/infoS1.html>http://localhost:3754/infoS1.html</a> "+ "\n\t" +
    ...
    public static String mostrarInfo(String server){
       String contenido="El contenido guardado por " + server + " es ";
        try {
        String rutaArchivo = "./sources/info/" + server + ".js";
        FileReader reader = new FileReader(rutaArchivo);
        ...
        // Recorrer las claves y obtener los valores
        for (String clave : claves) {
            contenido = contenido + clave + ": " + jsonObject.get(clave) + "\n";
        }
