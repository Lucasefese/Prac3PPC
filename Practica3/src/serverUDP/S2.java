...
public class S2 extends Thread {
    ...
    public void serializarJSON(String nombreServer) {
        ...
        jsonObject.addProperty("Presion Atmosferica", pa);
    ...
    public boolean validarArchivo() {
        ...
        String xmlFilePath = "./sources/info/cliente.xml";
    ...
    public String mostrarContenidoDeserializadoXML(String info){
        String rutaArchivo = "./sources/info/cliente.xml"; // Cambia esto por la ruta que desee
    ...
    public String mostrarContenidoDeserializadoJSON(String info){
        try {
            ...
            String rutaArchivo = "./sources/info/cliente.js"; // Cambia esto por la ruta que desees
